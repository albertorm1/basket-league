...
public class CenterPlayer extends Player {
    ...
    public CenterPlayer (String name, int height, int skill) throws PlayerInvalidDataException {
     ...
     */
    public CenterPlayer (String name, int number, int height, int skill, int points, Foul[] fouls) throws PlayerInvalidDataException {
