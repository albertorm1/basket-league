...
/**
 * Clase para jugadores base. 
 * @author Alberto Rodriguez Muelas
 */
public class PointGuardPlayer extends Player {
    ...
    public PointGuardPlayer (String name, int height, int skill) throws PlayerInvalidDataException {
     ...
     */
    public PointGuardPlayer (String name, int number, int height, int skill, int points, Foul[] fouls) throws PlayerInvalidDataException {
