...
/**
 * Clase para jugadores ala-pivot. 
 * @author Alberto Rodriguez Muelas
 */
public class PowerForwardPlayer extends Player {
    ...
    public PowerForwardPlayer (String name, int height, int skill) throws PlayerInvalidDataException {
     ...
     */
    public PowerForwardPlayer(String name, int number, int height, int skill, int points, Foul[] fouls) throws PlayerInvalidDataException {
    ...
    public PlayerType getType() {
        return PlayerType.POWER_FORWARD;
    }
}