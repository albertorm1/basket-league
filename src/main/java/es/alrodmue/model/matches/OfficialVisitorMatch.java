...
public class OfficialVisitorMatch extends Match {
     ...
     */
    public OfficialVisitorMatch(LocalDate date, Player[] players) throws MatchInvalidDataException, Exception {
        super(date, players);
    }
     ...
     */
    public OfficialVisitorMatch(int number, LocalDate date, int ownPoints, int rivalPoints, HashMap<Player, Integer> points) {
